        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 portfolio-item">
                <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
                    ...
                    <img src="<?php echo base_url('/assets/baked/agency/img/portfolio/roundicons.png')?>" class="img-responsive" alt="">
                </a>
            ...
            <div class="col-md-4 col-sm-6 portfolio-item">
                <a href="#portfolioModal2" class="portfolio-link" data-toggle="modal">
                    ...
                    <img src="<?php echo base_url('/assets/baked/agency/img/portfolio/startup-framework.png')?>" class="img-responsive" alt="">
                </a>
                <div class="portfolio-caption">
            ...
            <div class="col-md-4 col-sm-6 portfolio-item">
                <a href="#portfolioModal3" class="portfolio-link" data-toggle="modal">
                    ...
                    <img src="<?php echo base_url('/assets/baked/agency/img/portfolio/treehouse.png')?>" class="img-responsive" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Treehouse</h4>
                    <p class="text-muted">Website Design</p>
            ...
            <div class="col-md-4 col-sm-6 portfolio-item">
                <a href="#portfolioModal4" class="portfolio-link" data-toggle="modal">
                    ...
                    <img src="<?php echo base_url('/assets/baked/agency/img/portfolio/golden.png')?>" class="img-responsive" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Golden</h4>
                    <p class="text-muted">Website Design</p>
            ...
            <div class="col-md-4 col-sm-6 portfolio-item">
                <a href="#portfolioModal5" class="portfolio-link" data-toggle="modal">
                    ...
                    <img src="<?php echo base_url('/assets/baked/agency/img/portfolio/escape.png')?>" class="img-responsive" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Escape</h4>
                    <p class="text-muted">Website Design</p>
            ...
            <div class="col-md-4 col-sm-6 portfolio-item">
                <a href="#portfolioModal6" class="portfolio-link" data-toggle="modal">
                    ...
                    <img src="<?php echo base_url('/assets/baked/agency/img/portfolio/dreams.png')?>" class="img-responsive" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Dreams</h4>
                    <p class="text-muted">Website Design</p>
                ...
                <ul class="timeline">
                    <li>
                        <div class="timeline-image">
                            <img class="img-circle img-responsive" src="<?php echo base_url('/assets/baked/agency/img/about/1.jpg')?>" alt="">
                        </div>
                    ...
                    <li class="timeline-inverted">
                        <div class="timeline-image">
                            <img class="img-circle img-responsive" src="<?php echo base_url('/assets/baked/agency/img/about/2.jpg')?>" alt="">
                        </div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>March 2011</h4>
                    ...
                    <li>
                        <div class="timeline-image">
                            <img class="img-circle img-responsive" src="<?php echo base_url('/assets/baked/agency/img/about/3.jpg')?>" alt="">
                        </div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>December 2012</h4>
                    ...
                    <li class="timeline-inverted">
                        <div class="timeline-image">
                            <img class="img-circle img-responsive" src="<?php echo base_url('/assets/baked/agency/img/about/4.jpg')?>" alt="">
                        </div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>July 2014</h4>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="team-member">
                    <img src="<?php echo base_url('/assets/baked/agency/img/team/1.jpg')?>" class="img-responsive img-circle" alt="">
                    <h4>Kay Garland</h4>
            ...
            <div class="col-sm-4">
                <div class="team-member">
                    <img src="<?php echo base_url('/assets/baked/agency/img/about/2.jpg')?>" class="img-responsive img-circle" alt="">
                    <h4>Larry Parker</h4>
            ...
            <div class="col-sm-4">
                <div class="team-member">
                    <img src="<?php echo base_url('/assets/baked/agency/img/about/3.jpg')?>" class="img-responsive img-circle" alt="">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-6">
                <a href="#">
                    <img src="<?php echo base_url('/assets/baked/agency/img/logos/envato.jpg')?>" class="img-responsive img-centered" alt="">
                </a>
            </div>
            <div class="col-md-3 col-sm-6">
                <a href="#">
                    <img src="<?php echo base_url('/assets/baked/agency/img/logos/designmodo.jpg')?>" class="img-responsive img-centered" alt="">
                </a>
            </div>
            <div class="col-md-3 col-sm-6">
                <a href="#">
                    <img src="<?php echo base_url('/assets/baked/agency/img/logos/themeforest.jpg')?>" class="img-responsive img-centered" alt="">
                </a>
            </div>
            <div class="col-md-3 col-sm-6">
                <a href="#">
                    <img src="<?php echo base_url('/assets/baked/agency/img/logos/creative-market.jpg')?>" class="img-responsive img-centered" alt="">
                </a>
            </div>
        </div>
    </div>
