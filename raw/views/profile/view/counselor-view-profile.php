...
$profile['address'] = empty($profile['address']) ? '-' : $profile['address'];
$profile['school'] = empty($profile['school']) ? '-' : $profile['school'];
$profile['school_address'] = empty($profile['school_address']) ? '-' : $profile['school_address'];
$profile['head'] = empty($profile['head']) ? '-' : $profile['head'];
$profile['head_credential'] = empty($profile['head_credential']) ? '-' : $profile['head_credential'];
$profile['birthplace'] = empty($profile['birthplace']) ? '-' : $profile['birthplace'];
$profile['datebirth'] = empty($profile['datebirth']) ? '-' : Carbon::createFromFormat('Y-m-d', $profile['datebirth'])->formatLocalized('%d %B %Y');
